...
export const onSensorClick = (history: any, id: string, name: string, sensorId: string, setChartData: any, setPage: any, setSiteId: any, setSiteName: any, setLinesCount: any, siteList: any) => {
  if (sensorId !== id) {
